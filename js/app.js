...
function bindShell(){
  ...
  document.addEventListener('click',async e=>{
    try{
      ...
      const reviewId=e.target.closest('[data-review-claim]')?.dataset.reviewClaim;if(reviewId){const rows=await loadReviewQueue();return openClaimReview(rows.find(x=>x.id===reviewId),{onDone:()=>{state.route='review';renderApp();}});}
