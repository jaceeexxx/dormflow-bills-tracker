...
test('v3.3.4 is a real release and service worker cache boundary', () => {
...
test('v3.3.4 release tooling and docs point to the additive migration', () => {
  ...
  assert.match(docs, /migrate-v3\.3\.4\.sql/i);
